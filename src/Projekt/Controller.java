...
import static Projekt.FxProjekt.*;
...
public class Controller {
    ...
    public void onEnter() throws TühiSisendErind, IOException {
        ...
        if (!sisend.isEmpty()) {
            this.loodudSeed = pseudorandom(sisend);
            input.clear();
            ...
            joonistaPuu(peaPane, algusPunkt, 90, Integer.parseInt(seedstring.substring(10, 11)));
            ...
            for (int i = 0; i < 255; i++) {
                ...
                seedstring = pseudorandom(seedstring) + String.valueOf(1);
            }
